...
$id = $_GET['id'];
$fild = "*";
$where = "C.id_category=A.id_category AND A.id_article = '$id'";
foreach($dbase->select($tabel, $fild, $where) as $data){}
?>
<form action="mod/mod_article/actionArticle.php?update" method="POST" enctype="multipart/form-data">
	<table class="table">
		<tr>
		...
		<tr>
			...
			<td>
				<img src="../img/img_article/<?php echo $data['thumb_image']; ?>" width="150px" />
			</td>
		</tr>
        <?php } ?>
		<tr>
